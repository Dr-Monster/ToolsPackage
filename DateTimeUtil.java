...
public class DateTimeUtil {
    ...
    private final static String TIMESTAMP_FORMAT = "HHmmss";

    public final static String DATE_FORMAT_PAY = "yyyyMMddHHmmss";
    public final static String DATE_FORMAT_PAY_2Y = "yyMMddHHmmss";
    public final static String DATE_FORMAT_MS = "yyyyMMddHHmmssSSS";
    ...
    public static String getSQLFormatDateTime(java.util.Date currDate) {
        return getFormatDateTime(currDate, DATE_FORMAT_SQL);
    }
    ...
    public static String getSQLCurrDateTimeStr() {
        return getSQLFormatDateTime(getCurrDate());
    }
